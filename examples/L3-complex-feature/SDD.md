...
本例按 arc42 的关注点组织：目标/约束引用 PRD，结构用下面的 C4 视图，运行场景用有序文字，部署用映射表，质量与风险连接验收，选择理由进入 ADR。内容对应方式见 [按需写作参考](../../templates/README.md#用-arc42-组织本说明)。这是自写教学设计，不是实际项目架构盘点或完整 arc42 文档。
