...
提出澄清前仍按 [未知分流](../docs/WORKFLOW.md#未知怎样处理) 查项目事实，不能因技能包含提问阶段就重问已有决定。按当前问题选方法，已有充分依据即进入实施；评估类方法遵守 [评审范围](../docs/ENGINEERING_RULES.md#评审与清理)，不以更多功能或框架奖励偏离需求。使用前查真实工具能力，不能以技能描述代替可执行条件。
